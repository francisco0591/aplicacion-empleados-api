package com.fjulca.api.empleado.security.jwt;
...
import com.fjulca.api.empleado.handler.ForbiddenHandler;
import com.fjulca.api.empleado.handler.UnauthorizedHandler;
...
public class SecurityConfig {
	...
	private static final String[] AUTH_WHITELIST = {
			// -- Swagger UI v2
			"/api/login", "/v2/api-docs", "/swagger-resources", "/swagger-resources/**", "/configuration/ui",
